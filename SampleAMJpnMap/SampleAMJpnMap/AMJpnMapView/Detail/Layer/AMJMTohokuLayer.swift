...
class AMJMTohokuLayer: AMJMRegionLayer {
    ...
    private func drawAomori() {
        ...
        pointList.append(createPoint(x: 373, y: 179))// 岩手・青森
        pointList.append(createPoint(x: 357, y: 184))// 青森・岩手・秋田
        pointList.append(createPoint(x: 358, y: 182))
        pointList.append(createPoint(x: 352, y: 178))
        pointList.append(createPoint(x: 345, y: 181))
        pointList.append(createPoint(x: 332, y: 180))// 秋田・青森
    ...
    private func drawIwate() {
        ...
        pointList.append(createPoint(x: 353, y: 231))// 岩手・宮城・秋田
    ...
    private func drawAkita() {
        ...
        pointList.append(createPoint(x: 349, y: 214))
        pointList.append(createPoint(x: 353, y: 231))// 岩手・宮城・秋田
        pointList.append(createPoint(x: 346, y: 231))// 秋田・山形・宮城
    ...
    private func drawMiyagi() {
        ...
        pointList.append(createPoint(x: 340, y: 261))// 宮城・福島・山形
    ...
    private func drawFukushima() {
        ...
        pointList.append(createPoint(x: 313, y: 292))//福島・新潟・群馬
